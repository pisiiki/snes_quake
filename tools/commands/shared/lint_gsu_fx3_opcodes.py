"""Compatibility alias for :mod:`snes_tooling.shared.lint_gsu_fx3_opcodes`."""
...
_IMPLEMENTATION = importlib.import_module("snes_tooling.shared.lint_gsu_fx3_opcodes")
